...
const int length = 4;
const float spaceBetweenParticles = 5.2f;
#ifdef DEBUG
    ...
    slmath::vec4 colors[] = {   slmath::vec4(0.1f, 0.15f, 0.3f, 0.6f),
                                slmath::vec4(0.1f, 0.15f, 0.3f, 0.6f),
                                slmath::vec4(0.1f, 0.15f, 0.3f, 0.6f),
                                slmath::vec4(1.0f, 1.0f, 0.0f, 0.4f),
                                slmath::vec4(0.2f, 0.05f, 0.05f, 15.0f),
